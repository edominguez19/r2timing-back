...
module.exports = function setupParticipante (ParticipanteModel) {
  ...
  async function findAll ({ where, page, pageSize }) {
    return new Promise((resp, reject) => {
      ...
      ParticipanteModel.findAndCountAll({
        where: { ...whereQuery },
        offset,
        limit,
        raw: true,
  ...
  async function createOrUpdate (model) {
    return new Promise((resp, reject) => {
        ...
        if (instanceModel) {
            ...
            ParticipanteModel.update(model, {
            where: {
            ...
            ParticipanteModel.create(model).
