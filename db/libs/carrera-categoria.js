...
module.exports = function setupCarreraCategoria (CarreraCategoriaModel) {
  ...
  async function findAll ({ where, page, pageSize }) {
    return new Promise((resp, reject) => {
      ...
      CarreraCategoriaModel.findAndCountAll({
        where: { ...whereQuery },
        offset,
        limit,
        raw: true,
    ...
    return new Promise((resp, reject) => {
      CarreraCategoriaModel.findOne({
        ...
        if (instanceModel) {
          ...
          CarreraCategoriaModel.update(model, {
            where: {
          ...
          CarreraCategoriaModel.create(model).
