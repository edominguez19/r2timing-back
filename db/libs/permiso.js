...
module.exports = function setupPermisos (PermisosModel) {
    ...
    return new Promise((resp, reject) => {
      PermisosModel.findOne({
        ...
        if (instanceModel) {
          ...
          PermisosModel.update(model, {
            where: {
              idPermiso: instanceModel.idPermiso,
            },
          }).
